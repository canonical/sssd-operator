# Contributing to `sssd-operator`

Do you want to contribute to the `sssd-operator` repository? You've come to the right place then!
...
you can use this guide for specific information on contributing to the `sssd-operator` repository.
...
## Hacking on `sssd-operator`

This repository uses [just](https://github.com/casey/just) and [uv](https://github.com/astral-sh/uv) for development
which provide some useful commands that will help you while hacking on `sssd-operator`:
...
### Before opening a pull request on the `sssd-operator` repository
...
By contributing to `sssd-operator`, you agree to license your contribution under
the Apache License 2.0 license.

### Adding a new file to `sssd-operator`
...
### Updating an existing file in `sssd-operator`
